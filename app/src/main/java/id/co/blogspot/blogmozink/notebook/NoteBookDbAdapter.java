...
/**
 * Created by Axoriea-LPMX on 22/11/2016.
 */
...
public class NoteBookDbAdapter {
    ...
    public long updateNote(long idToUpdate, String newTitle, String newMessage, Note.Category newCat)
    {   ContentValues values = new ContentValues();
        values.put(COLUMN_TITLE,newTitle);
        values.put(COLUMN_MESSAGE, newMessage);
        values.put(COLUMN_CATEGORY,newCat.name());
        values.put(COLUMN_DATE, Calendar.getInstance().getTimeInMillis() + "");
